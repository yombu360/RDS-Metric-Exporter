...
class Metrics:
    ...
    def __init__(self, period, db_name, db_engine, availability_zone, region="us-east-1", access_key=None, secret_access_key=None):
        """
    ...
    def get_metrics_from_cloud_watch(self):
        ...
        if self.db_engine == "maria" or self.db_engine == "aurora":
            db_metrics_dict = self.METRICS.get(self.db_engine)
